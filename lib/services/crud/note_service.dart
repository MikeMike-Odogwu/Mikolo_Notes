...
import 'package:mikolo_notes/services/crud/crud_exceptions.dart';
...
class NotesService {
  ...
  Future<void> open() async {
    ...
    try {
      ...
      // Now creating the database if they dont exist prior to calling open database
      // create user Table
...
class DatabaseNote {
  ...
  DatabaseNote.fromRow(Map<String, Object?> map)
      : id = map[idColumn] as int,
        ...
        // Check in the case there is error i change the true or false to 1 and 0 respectively
